    ...
    <main className="mx-auto">
      ...
      <div>
        <div className="flex flex-col items-start bg-revolutionizing bg-cover mt-2 p-6 md:p-16">
          ...
          <div className="flex flex-row space-x-4 md:space-x-8 mt-8 mb-24 md:mb-36 lg:mb-72">
            <Link href="#" className="bg-[#056B34] h-8 w-48 md:w-[300px] md:h-[50px] lg:w-[407px] lg:h-[70px] rounded-md text-white flex justify-center items-center text-xs md:text-base lg:text-xl font-semibold">
              ...
              <AppleIcon className="text-2xl md:text-3xl ml-1 md:ml-3" />
            </Link>
            <Link href="#" className="bg-[#056B34] h-8 w-48 md:w-[300px] md:h-[50px] lg:w-[407px] lg:h-[70px] rounded-md text-white flex justify-center items-center text-xs md:text-base lg:text-xl font-semibold">
              Download on Playstore
              <PlaystoreIcon className="text-lg md:text-2xl ml-2 md:ml-3" />
            </Link>
          </div>
        </div>
        <div className="my-10 px-10 md:px-20 lg:px-40 text-sm md:text-base lg:text-[29px] text-black text-justify">
        ...
        <div className="mx-16 my-20 text-black text-justify text-base md:text-xl lg:text-[27px] font-medium">
        ...
        <div className="flex flex-row bg-request-service bg-cover px-6 md:px-12 lg:px-24 space-x-5">
